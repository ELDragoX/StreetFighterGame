...
let player1=new Player('Alpha',100,10) 
let player2=new Player('Sigma',100,10) 
...
document.addEventListener('keydown', function(e) {
  // if you press Q AND tqhe enemy health is greater than 0 AND isOver is still false then strike()
...
document.addEventListener('keydown', function(e) {
  ...
  // if you press S AND the player health is greater than 0 AND isOver is still false then strike()
if(e.key == 's' && p2.health > 0 && game.isOver == false){
